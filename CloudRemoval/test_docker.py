...
def parse_options(is_train=False):
    ...
    parser.add_argument('-opt', type=str,
                        default='CloudRemoval/Options/0901_cr_restormer-s_128x128_1xb16_160k_alld_l1.yml',
                        help='Path to option YAML file.')
    parser.add_argument('-ckpt', type=str,
                        default='/work/experiments/0901_cr_restormer-s_128x128_1xb16_160k_alld_l1/models/net_g_latest.pth')
